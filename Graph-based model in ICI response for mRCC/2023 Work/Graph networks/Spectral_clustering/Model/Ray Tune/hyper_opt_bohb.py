...
def train_rna(config):
  ...
  with open("/home/sandralonso/2023_work/spectral_clustering/spectral_clustering_feature_selection/CNN/Results/Test_patients_X.txt", "w") as file:
        for i in range(len(X_test)):
           file.write(str(X_test[i]) + '\n')
  with open("/home/sandralonso/2023_work/spectral_clustering/spectral_clustering_feature_selection/CNN/Results/Test_patients_Y.txt", "w") as file:
  ...
  for train_index, val_index in kf.split(X_train, Y_train):
      ...
      csv_logger = CSVLogger('/home/sandralonso/2023_work/spectral_clustering/spectral_clustering_feature_selection/CNN/Results/log_bo.csv', append=True, separator=';')
  ...
  with open("/home/sandralonso/2023_work/spectral_clustering/spectral_clustering_feature_selection/CNN/Results/folds_results_bo.txt", "a") as file:
...
tuner = tune.Tuner(
    train_rna,
    run_config=air.RunConfig(name="bohb_test", stop={"accuracy": 0.99}),
...
with open("Results/best_result_bo.txt", 'w') as file:
  file.write('Best config; '+ str(best_config))
  file.write('Best result: ' +str(results.get_best_result()))
with open("Results/all_results_bo.txt", 'w') as file:
  for i in results:
    file.write(str(i)+'\n')