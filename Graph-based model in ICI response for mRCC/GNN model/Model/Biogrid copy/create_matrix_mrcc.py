...
path ='GNN model/Model/Biogrid copy/Data/biogrid_minimum.edgelist'
...
print(data)
# print(data)
data.to_csv('GNN model/Model/Biogrid copy/Data/network_edges.tsv', sep="\t")
...
print(not_in)
final_genes.to_csv('GNN model/Model/Biogrid copy/Data/mrcc_protein_matrix.csv')