...
encoder.save('/content/drive/MyDrive/UPM/Internship/Autoencoder/Binary/200/encoder_binary_200.h5')
encoder = models.load_model('/content/drive/MyDrive/UPM/Internship/Autoencoder/Binary/200/encoder_binary_200.h5')
data_encode = encoder.predict(data)
data_encode = pd.DataFrame(data_encode)
data_encode.insert(0,"Target", label)
data_encode

data_encode.to_csv("/content/drive/MyDrive/UPM/Internship/Autoencoder/Binary/200/encoded_data_binary_200.csv")