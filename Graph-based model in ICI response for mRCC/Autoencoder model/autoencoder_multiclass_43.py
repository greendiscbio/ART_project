# -*- coding: utf-8 -*-
"""Autoencoder_multiclass_43.ipynb
Original file is located at
    https://colab.research.google.com/drive/1RCfZaGEWbVAP6xZn9R1EqLMjDnRYKFtu
"""
...
encoder.save('/content/drive/MyDrive/UPM/Internship/Autoencoder/Multiclass/43/encoder_multiclass_43.h5')
encoder = models.load_model('/content/drive/MyDrive/UPM/Internship/Autoencoder/Multiclass/43/encoder_multiclass_43.h5')
data_encode = encoder.predict(data)
data_encode = pd.DataFrame(data_encode)
data_encode.insert(0,"Target", label)
data_encode

data_encode.to_csv("/content/drive/MyDrive/UPM/Internship/Autoencoder/Multiclass/43/encoded_data_multiclass_43.csv")