...
path ='GNN model\Data\Programmed cell death protein\string_interactions_pd-1.tsv'
data = pd.read_csv(path, delimiter='\t')
data = data[['#node1', 'node2']]
data.to_csv('GNN model/Data/Programmed cell death protein/network_edges_pd-1.tsv', sep="\t")
...
final_genes.to_csv("GNN model\Data\Programmed cell death protein\Programmed_cell_death_protein_matrix.csv")