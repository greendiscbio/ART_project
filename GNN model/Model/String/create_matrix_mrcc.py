...
path ='GNN model/Model/String/Data/string_minimum_graph.edgelist'
...
print(data)
# print(data)
data.to_csv('GNN model/Model/String/Data/network_edges.tsv', sep="\t")
...
print(not_in)
final_genes.to_csv('GNN model/Model/String/Data/mrcc_protein_matrix.csv')