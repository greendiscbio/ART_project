...
def BFS(RNA_file, RNA_30_file, String_file):
    ...
    edge_list_file = 'GNN model\Model\Data\biogrid_maximum.edgelist'
    ...
    # Save graph
    nx.write_edgelist(minimum_graph, "GNN model/Model/Biogrid/Data/biogrid_maximum.edgelist")
...
BFS('GNN model/Data/all_genes_db.txt', 'GNN model/Data/rna_30.txt', 'GNN model\Model\String\string_output.tsv')