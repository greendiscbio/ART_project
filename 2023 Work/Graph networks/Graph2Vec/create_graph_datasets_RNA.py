...
def create_rna_file(ppi, level):
   ...
   rna_data.to_csv(f'Data/RNA_Disgenet_matrix_{level}.csv')
   return rna_data
...
if __name__ == "__main__":
   ...
   n = input()
   ppi = nx.read_edgelist('Data/biogrid_found_genes_level_'+str(n)+'_disgenet.edgelist')
   print(ppi)
   ...
   with open('Data/RNA_dataset_'+str(n)+'.pkl', 'wb') as f:
