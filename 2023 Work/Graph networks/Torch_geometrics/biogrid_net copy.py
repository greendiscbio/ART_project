...
def get_biogrid(genes_file):
    ...
    for g in geneList:
        print("Gene : "+ str(g))
        G = create_net(0, 1, geneList, g, g, G)
        # ------------------------------------------------------------------------------ #
    ...
    # Save graph
    nx.write_edgelist(G, "Graph networks/Torch_geometrics/Data/g00.edgelist")
    ...
    # plt.show()
a = get_biogrid('Graph networks/Torch_geometrics/biogrid_net copy.py')
